...
window.addEventListener('DOMContentLoaded', () => {
    ...
    const entryActions = {
        ...
        openAvatarCustomizer: () => callGlobal('openAvatarCustomizer'),
        closeAvatarCustomizer: () => callGlobal('closeAvatarCustomizer'),
        ...
        openMallFeedback: () => callGlobal('openMallFeedback'),
