...
-- 2. select id, store_id, local_code from public.tenant_leases order by id;
-- 3. select physical_space_id, store_id, relation_type from public.store_physical_links order by store_id, physical_space_id;
